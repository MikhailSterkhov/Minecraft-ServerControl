...
// ================================================================================================================== //
     ...
     * @param objectName - имя данных для объекта
     */
    public org.stonlexx.servercontrol.api.utility.ValidatedObject getValidatedObject(@NonNull String objectName) {
        return new org.stonlexx.servercontrol.api.utility.ValidatedObject(getObject(Object.class, objectName));
    }
